 ...
 */
final class Version20220322132450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE register_at register_at DATETIME NOT NULL');
    }
